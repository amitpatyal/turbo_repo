...
export default function Home() {
  ...
  //   user: { id: "1", email: "amit@example.com", name: "Amit Patyal" },
  // });
  ...
  const { data, isLoading, error } = useQuery({
    queryKey: ["users"],
    queryFn: fetchUsers,
    retry: 1, // override global default
  });
            ...
            <div className="flex items-center gap-4">
              <div className="sm:flex sm:gap-4">
                <Button
                  ...
                  onClick={() =>
                    alert(
                      `User name for store:-  ${user?.name} & ${profile?.address}`
                    )
                  }
                >
                  Login
            ...
            <table className="min-w-full divide-y-2 divide-gray-200 dark:divide-gray-700">
              ...
              <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                ...
                {isLoading ? (
                  <tr className="*:text-gray-900 *:first:font-medium dark:*:text-white">
                    <td className="px-3 py-2 whitespace-nowrap">
                      <Loader2 className="mr-2 h-6 w-6 animate-spin justify-center" />
                    </td>
                  </tr>
                ) : (
                  data?.map((user: any) => (
